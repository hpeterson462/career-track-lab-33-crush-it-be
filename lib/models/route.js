...
module.exports = class Route {
  ...
  static async insert(route) {
    const { rows } = await pool.query(
      `INSERT INTO routes (users_id, location, name, rating, notes) VALUES ($1, $2, $3, $4, $5) 
      RETURNING *`,
      [route.usersId, route.location, route.name, route.rating, route.notes]
    );
    console.log(this.state, 'hhheeelloooo');
